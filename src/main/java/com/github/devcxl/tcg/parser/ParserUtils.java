...
import com.github.devcxl.tcg.model.FieldType;
...
import static com.github.devcxl.tcg.model.FieldType.build;
...
public class ParserUtils {
    ...
    static {
        ...
        // java.sql.Date ?
        sqlTypes.put("DATE", FieldType.build("java.time.LocalDateTime"));
        // java.sql.Timestamp ?
        sqlTypes.put("DATETIME", FieldType.build("java.time.LocalDateTime"));
        // java.sql.Timestamp ?
        sqlTypes.put("TIMESTAMP", FieldType.build("java.time.LocalDateTime"));
        // java.sql.Time ?
        sqlTypes.put("TIME", FieldType.build("java.time.LocalTime"));
